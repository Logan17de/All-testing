...
Phase 4  Runtime daemon + SQLite           🚧 WE ARE HERE
           ...
           └─ 4.11 sparse checkpoints/frontier state                       ▶ CURRENT
...
| **4 — Runtime daemon + SQLite durability** | long-lived Node runtime, HTTP/SSE, `node:sqlite`, WAL, events, checkpoints, blobs, crash recovery, lightweight baseline | 🚧 In progress — **4.11 current** |
...
> **Phase 4 / Item 4.11 — Define sparse checkpoints/frontier state.**