...
Phase 11 Packaging + optional scale-out    🚧 4/9
```
...
| **11 — Packaging + Optional scale-out** | Windows setup, config wizard, backup/import/export, optional desktop shell, optional Postgres/remote workers | 🚧 11.1-11.3 and 11.5 done; 11.4, 11.6–11.9 are gated on a named need |
