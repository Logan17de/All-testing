...
Phase 4  Runtime daemon + SQLite           🚧 WE ARE HERE
           ...
           └─ 4.12 filesystem content-addressed blob store                 ▶ CURRENT
...
| **4 — Runtime daemon + SQLite durability** | long-lived Node runtime, HTTP/SSE, `node:sqlite`, WAL, events, checkpoints, blobs, crash recovery, lightweight baseline | 🚧 In progress — **4.12 current** |
...
> **Phase 4 / Item 4.12 — Add a filesystem content-addressed blob store for large immutable values.**