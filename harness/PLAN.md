...
| **1 — Plugin API + universal node contract** | freeze the tiny public extension boundary, plugin lifecycle, registry, node manifests, built-in/external plugin parity | 🚧 In progress — **1.5 current** |
...
> **Phase 1 / Item 1.5 — Add a generic typed registry primitive used by plugin-provided capabilities.**
