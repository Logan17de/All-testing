...
Phase 4  Runtime daemon + SQLite           🚧 WE ARE HERE
           ...
           └─ 4.18 SQLite/file-level backup + restore                          ▶ CURRENT
...
| **4 — Runtime daemon + SQLite durability** | long-lived Node runtime, HTTP/SSE, `node:sqlite`, WAL, events, checkpoints, blobs, crash recovery, lightweight baseline | 🚧 In progress — **4.18 current** |
...
> **Phase 4 / Item 4.18 — Add backup/restore using SQLite/file-level facilities.**