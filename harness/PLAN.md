...
Phase 3  In-memory DAG scheduler           🚧 WE ARE HERE
           ...
           └─ 3.13 typed runtime event emitter                         ▶ CURRENT
...
| **3 — In-memory DAG Scheduler** | readiness queue, bounded concurrency, routers, activation-aware joins, cancellation, timeout, retry, runtime events | 🚧 In progress — **3.13 current** |
...
> **Phase 3 / Item 3.13 — Add small typed runtime event emitter.**
