...
Phase 4  Runtime daemon + SQLite           🚧 WE ARE HERE
           ...
           └─ 4.13 serialized short SQLite commit path                       ▶ CURRENT
...
| **4 — Runtime daemon + SQLite durability** | long-lived Node runtime, HTTP/SSE, `node:sqlite`, WAL, events, checkpoints, blobs, crash recovery, lightweight baseline | 🚧 In progress — **4.13 current** |
...
> **Phase 4 / Item 4.13 — Keep short SQLite writes serialized through one clear commit path.**