...
progress: routers, joins, bounded loops and subgraphs run durably, and projects and agent mode come next. [`PLAN.md`](./PLAN.md) holds the
...
Phase 8  Loops + projects + agent mode      🚧 in progress (control flow, loops + subgraphs done)
