...
progress: routers, joins, bounded loops and subgraphs run durably, projects and their
conversations are stored and served by the runtime, and goals and agent mode come next. [`PLAN.md`](./PLAN.md) holds the
...
Phase 8  Loops + projects + agent mode      🚧 in progress (control flow, loops, subgraphs, projects + conversations done)
