...
work through them. Phase 9 is complete: replay, forking, project memory, conversation summarization, triggers and external clients. [`PLAN.md`](./PLAN.md) holds the
