...
conversations, goals and todos are stored and served by the runtime, and agent mode comes next. [`PLAN.md`](./PLAN.md) holds the
...
Phase 8  Loops + projects + agent mode      🚧 in progress (control flow, loops, subgraphs, projects, conversations + goals done)
