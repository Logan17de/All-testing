...
- Blob bytes are published atomically and verified on reuse; Phase 4.14 will use the serialized commit path to make node completion + output reference + terminal event one atomic durability boundary.
